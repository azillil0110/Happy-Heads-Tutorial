...
<div class="contact-form">
    ...
    <div class="top-container">
        <div>
            <img id="img-1" src="2X2 (1).jpg" alt="2x2 Image">
        </div>
        <form action="update-settings.php" method="POST">
            ...
            <div class="description">
                <h5>Description</h5>
                <textarea required ="" cols="77" rows="6" placeholder="Short description" name="description" id="description" required></textarea>
                </div>
            <div>
