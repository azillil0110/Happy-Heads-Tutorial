...
<body>
    <div class="overlay" id="pendingStudent">
        <div class="overlay-content">
            <h2>Student Information</h2>
            <form method="POST" action="accept-pending-student.php">
                <div class="row">
                    <input type="text" id="studentid" name="studid" type="hidden" style="display:none" readonly>
                ...
                <div class="row">
                    <div class="col-70">
                        <label class="lightlabel" for="student-ques1-option">Is your child taking any medications or has
                            any
                ...
                <div class="row">
                    ...
                    <div class="col-30">
                        <div class="option" id="student-ques2-option">
                            <input class="radiobtn2" type="radio" id="student-pic-consent1" name="yesno_pic"
                                value="yes">
                ...
                <div class="row">
                    ...
                    <div class="col-60" id="subrow">
                        ...
                        <div class="btn">
                            <button type="submit" class="save-btn">Accept</button>
